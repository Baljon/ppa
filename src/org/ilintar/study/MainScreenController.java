...
import org.ilintar.study.question.event.QuestionAnswerListener;
...
public class MainScreenController {
    ...
    static {
       ...
       // factoryMap.put("checkbox", new CheckboxQuestionFactory());
    ...
    private Node createQuestion(List<String> questionLines, String questionType) {
        ...
        q.addQuestionAnsweredListener(new QuestionAnswerListener(answerHolder, this));
        return q.getRenderedQuestion();
    }

    public void readNewQuestion() throws IOException {
